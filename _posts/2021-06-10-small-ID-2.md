...
![](../assets/produit-1.png){: .center-image width="80%"}
...
![](../assets/produit-2.png){: .center-image width="80%"}
...
![](../assets/grd.png){: .center-image width="80%"}
...
$\beta (2d)^2$.
Thus we want $2(r+g(\beta (2d)^2))\leq d$. 
Let's make our life easy and make this happen by assuming:
$g(n)\leq \frac{\sqrt{n}}{2\sqrt{\beta}}-r$. (This is for large enough $n$.)
