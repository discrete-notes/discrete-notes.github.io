...
* [Emmanuelle Anceaume](https://people.irisa.fr/Emmanuelle.Anceaume/).
    Data stream algorithms, reputation mechanisms, dependability issues in 
    peer-to-peer systems, blockchain technologies.
* [George Giakkoupis](https://sites.google.com/site/ggiakk).
    Design and analysis of algorithms, with emphasis on distributed 
...
Large-scale distributed computer systems, programmability of distribution, 
...
Synchronization, fault-tolerance, scalability, group communication, data 
consistency and checkpointing.
* [Matthieu Perrin](https://matthieu-perrin.fr/).
Message-passing distributed systems, weakly consistent shared objects, 
message broadcast primitives.


### Grenoble Alpes University - Verimag and GSCOP

* [Karine Altissen](https://www-verimag.imag.fr/Karine-Altisen,102.html?lang=en).
Fault tolerant distributed algorithms: design and (pen-and-paper) proof, 
...
* [Matthieu Roy](https://homepages.laas.fr/mroy/LAAS/Home.html).
    ...
    human-carried distributed systems, real-time systems and distributed 
    embedded systems.
...
* [Philippe Quéinnec](http://queinnec.perso.enseeiht.fr/).
    Distributed embedded systems and distributed real time systems, 
    refinement of concurrent and distributed. algorithms, verification of asynchronous communicating systems
